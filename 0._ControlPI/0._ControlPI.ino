...
double Kp=6, Ki=2, Kd=0;
//Objeto PID parametrizado
PID PIAC(&Input, &Output, &Setpoint, Kp, Ki, Kd, DIRECT);
...
void setup() {
  ...
  PIAC.SetOutputLimits(22, 24);
  //Encender el controlador PID
  PIAC.SetMode(AUTOMATIC);
}
